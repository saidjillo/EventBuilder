	  ...
	  $("#dura").click(function(e){
		  ...
		  if(action === 1){
                  ...
                  if (Modernizr.mq('only screen and (max-width:320px)')) {
					    ...
					    $("#form2").css({"marginLeft":"0%","width":"100%","height":"100%"
						,"marginTop":"0%","marginBottom":"0%","zIndex":"2050"})
						$("#yul").hide();
						$("#yulia").hide();
						$("#first_name").css({"height":"25px","marginTop":"1%"});
						$("#last_name").css({"height":"25px","marginTop":"1%"});
						$("#forepass_email").css({"height":"25px","marginTop":"1%"});
						$("#field_pass1").css({"height":"25px","marginTop":"1%"});
						$("#field_pass").css({"height":"25px","marginTop":"1%"});
						action = 0;
				  ...
				  else if(Modernizr.mq('(min-width:321px) and (max-width:479px)')){
					      $("#form2").css({"marginLeft":"0%","width":"100%","height":"100%"
						,"marginTop":"0%","marginBottom":"0%","zIndex":"2050"})
						$("#yul").hide();
						$("#yulia").hide();
						...
						$(window).resize(function(){
					  	...
					  	$("#form2").css({"marginLeft":"35%","width":"500px","height":"100%"
						,"marginTop":"0%","marginBottom":"0%","zIndex":"2050"})
						/*$("#yul").hide();
						$("#yulia").hide();
						$("#first_name").css({"height":"25px","marginTop":"1%"});
				  ...
				  else if(Modernizr.mq('(min-width:1024px) and (max-width:1279px)')){
					  
					    $("#form2").css({"marginLeft":"50%","width":"500px","height":"auto"
						,"marginTop":"0%","marginBottom":"0%","zIndex":"2050"})
						/*$("#yul").hide();
						$("#yulia").hide();
						$("#first_name").css({"height":"25px","marginTop":"1%"});
						...
						$(window).resize(function(){
					  	 ...
					  	 $("#form2").css({"marginLeft":"45%","zIndex":"2050"})
